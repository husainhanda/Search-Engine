...
public class BoyerMooreAlgorithm {
    ...
    public BoyerMooreAlgorithm(char[] pattern, int R) {
        this.R = R;
    ...
    public static void main(String[] args) {
        ...
        BoyerMooreAlgorithm boyermoore1 = new BoyerMooreAlgorithm(pat);
        BoyerMooreAlgorithm boyermoore2 = new BoyerMooreAlgorithm(pattern, 256);
